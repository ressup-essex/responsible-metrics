...
-   What research metrics were used? 
...
A number of guidelines have been published which look to shape our approach to responsible metrics. The University has its own <a href="https://www.essex.ac.uk/-/media/documents/directories/reo/the-responsible-use-of-metrics-at-the-university-of-essex.pdf" target="_blank" rel="noopener noreferrer">responsible metrics policy</a> which is based on the principles of DORA. Below are summaries of three key international initiatives, each of which advise on a different aspect: 
